  ...
  Feature: Verify the header functions
    ...
    # TEST number 2 #CANNOT BE AUTOMATED BECAUSE SELENIUM DOES NOT KNOW HOW TO DEAL WITH CAPTCHA TODO sa ii intreb daca are rost sa fac si pasii testului care nu se poate automatiza pana la final?
